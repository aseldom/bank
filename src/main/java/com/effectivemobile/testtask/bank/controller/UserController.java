...
public class UserController {
    ...
    public ResponseEntity<UserReturnDto> saveUser(@Valid @RequestBody UserCreateDto userCreateDto) {
        UserReturnDto userReturnDto = userService.saveUser(userCreateDto).get();
    ...
    public ResponseEntity<UserReturnDto> addPhone(@Valid @RequestBody PhoneAddDto phoneAddDto, Principal principal) {
        UserReturnDto updatedUser = phoneService.addPhone(principal.getName(), phoneAddDto);
        return ResponseEntity.ok(updatedUser);
    }

    @PutMapping("/change-phone")
    public ResponseEntity<UserReturnDto> changePhone(@Valid @RequestBody PhoneChangeDto phoneChangeDto, Principal principal) {
        UserReturnDto updatedUser = phoneService.changePhone(principal.getName(), phoneChangeDto);
        return ResponseEntity.ok(updatedUser);
    }

    @DeleteMapping("/delete-phone")
    public ResponseEntity<String> deletePhone(@Valid @RequestBody PhoneDeleteDto phoneDeleteDto, Principal principal) {
        try {
    ...
    public ResponseEntity<UserReturnDto> addEmail(@Valid @RequestBody EmailAddDto emailAddDto, Principal principal) {
        UserReturnDto updatedUser = emailService.addEmail(principal.getName(), emailAddDto);
        return ResponseEntity.ok(updatedUser);
    }

    @PutMapping("/change-email")
    public ResponseEntity<UserReturnDto> changePhone(@Valid @RequestBody EmailChangeDto emailChangeDto, Principal principal) {
        UserReturnDto updatedUser = emailService.changeEmail(principal.getName(), emailChangeDto);
        return ResponseEntity.ok(updatedUser);
    }

    @DeleteMapping("/delete-email")
    public ResponseEntity<String> deleteEmail(@Valid @RequestBody EmailDeleteDto deleteEmailDto, Principal principal) {
        try {
